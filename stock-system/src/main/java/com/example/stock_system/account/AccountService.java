...
import com.example.stock_system.account.utils.AccountCommunicator;
...
public class AccountService {
    ...
    private final AccountCommunicator accountCommunicator;
    ...
    //fixme 랭킹
    public void createRanking(Account account, int teamId) {
        RankingDto rankingDto = RankingDto.builder()
                .category(accountCommunicator.getCategoryFromGroupInvestmentSystem(teamId))
                .account(account)
                .seedMoney(0)
                .evluPflsRt(0)
                .teamId(teamId)
        ...
        rankingRepository.save(rankingDto.toEntity());
    }
}
